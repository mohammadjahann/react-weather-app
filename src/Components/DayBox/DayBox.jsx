...
export default function DayBox({ dayData }) {
    ...
    return (
      ...
      flex flex-col items-center justify-between p-1
       h-36 md:h-48 m-2  rounded-2xl shadow-md
    ...
    ">
            <p className=" text-[10px] md:text-sm font-semibold text-gray-800 dark:text-gray-200 text-center">
                {dateInfo}
            </p>
            <img src={waetherIcons[icon]} alt="" className="w-14 h-14" />
            <p className="text-[10px] md:text-sm  text-gray-700 dark:text-gray-300 text-center">
                {weatherTranslations[waether]}
            </p>
            <p className="text-[10px] md:text-lg font-bold text-blue-600 dark:text-blue-400">
